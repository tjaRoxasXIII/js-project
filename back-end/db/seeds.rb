...
Enemy.create(name: "Orc", hp: 30, attack: 10, points: 600)
Enemy.create(name: "Theif", hp: 10, attack: 15, points: 500)
Enemy.create(name: "Wyvern", hp: 25, attack: 9, points: 400)
Enemy.create(name: "Undead", hp: 15, attack: 11, points: 300)

Hero.create(name: "Red", hp: 20, attack: 8)
Hero.create(name: "Blue", hp: 15, attack: 10)
Hero.create(name: "Green", hp: 30, attack: 5)